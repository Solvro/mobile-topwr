...
@widgetbook.UseCase(name: "default", type: DigitalGuideFeaturesSection)
Widget useCaseDigitalGuideFeaturesSection(BuildContext context) {
  return const DigitalGuideFeaturesSection(digitalGuideData: _mockDigitalGuideData, building: _mockBuilding);
}
