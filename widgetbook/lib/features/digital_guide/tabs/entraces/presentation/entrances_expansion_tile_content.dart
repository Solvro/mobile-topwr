...
@widgetbook.UseCase(name: "default", type: EntrancesExpansionTileContent)
Widget useCaseEntrancesExpansionTileContent(BuildContext context) {
  return const EntrancesExpansionTileContent(digitalGuideData: _mockDigitalGuideData);
}
