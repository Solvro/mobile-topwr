...
@widgetbook.UseCase(name: "default", type: DigitalGuideEntranceWidget)
Widget useCaseDigitalGuideEntranceWidget(BuildContext context) {
  return const DigitalGuideEntranceWidget(entrance: mockDigitalGuideEntrace);
}
