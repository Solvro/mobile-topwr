...
@widgetbook.UseCase(name: "default", type: MicronavigationExpansionTileContent)
Widget useCaseMicronavigationExpansionTileContent(BuildContext context) {
  return const MicronavigationExpansionTileContent(digitalGuideData: _mockDigitalGuideData);
}
