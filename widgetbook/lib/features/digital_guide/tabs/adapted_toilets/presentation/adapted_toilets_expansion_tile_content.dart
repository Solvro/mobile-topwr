...
@widgetbook.UseCase(name: "default", type: AdaptedToiletsExpansionTileContent)
Widget useCaseAdaptedToiletsExpansionTileContent(BuildContext context) {
  return const AdaptedToiletsExpansionTileContent(digitalGuideData: _mockDigitalGuideData);
}
