...
@widgetbook.UseCase(name: "default", type: EvacuationWidget)
Widget useCaseEvacuationWidget(BuildContext context) {
  return const EvacuationWidget(digitalGuideData: _mockDigitalGuideData);
}
