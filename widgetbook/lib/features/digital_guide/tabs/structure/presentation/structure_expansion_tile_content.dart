...
@widgetbook.UseCase(name: "default", type: StructureExpansionTileContent)
Widget useCaseStructureExpansionTileContent(BuildContext context) {
  return const StructureExpansionTileContent(digitalGuideData: _mockDigitalGuideData);
}
