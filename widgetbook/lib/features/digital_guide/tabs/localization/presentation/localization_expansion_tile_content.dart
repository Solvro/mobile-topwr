...
@widgetbook.UseCase(name: "default", type: LocalizationExpansionTileContent)
Widget useCaseLocalizationExpansionTileContent(BuildContext context) {
  return const LocalizationExpansionTileContent(digitalGuideData: _mockDigitalGuideData, building: _mockBuilding);
}
