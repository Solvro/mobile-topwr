...
@widgetbook.UseCase(name: "default", type: DigitalGuideLodgeExpansionTileContent)
Widget useCaseDigitalGuideLodgeExpansionTileContent(BuildContext context) {
  return const DigitalGuideLodgeExpansionTileContent(_mockDigitalGuideData);
}
