...
@widgetbook.UseCase(name: "default", type: DigitalGuideRoomExpansionTileContent)
Widget useCaseDigitalGuideRoomExpansionTileContent(BuildContext context) {
  return const DigitalGuideRoomExpansionTileContent(digitalGuideResponse: _mockDigitalGuideData);
}
