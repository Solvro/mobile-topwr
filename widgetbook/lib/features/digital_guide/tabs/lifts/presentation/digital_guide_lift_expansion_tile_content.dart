...
@widgetbook.UseCase(name: "default", type: DigitalGuideLiftExpansionTileContent)
Widget useCaseDigitalGuideLiftExpansionTileContent(BuildContext context) {
  return const DigitalGuideLiftExpansionTileContent(digitalGuideResponse: _mockDigitalGuideData);
}
