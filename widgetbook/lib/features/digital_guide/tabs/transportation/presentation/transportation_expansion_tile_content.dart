...
@widgetbook.UseCase(name: "default", type: TransportationExpansionTileContent)
Widget useCaseTransportationExpansionTileContent(BuildContext context) {
  return const TransportationExpansionTileContent(digitalGuideData: _mockDigitalGuideData);
}
