...
import "package:topwr/features/digital_guide/tabs/amenities/presentation/amenities_expansion_tile_content.dart";
...
@widgetbook.UseCase(name: "default", type: AmenitiesExpansionTileContent)
Widget useCaseAmenitiesExpansionTileContent(BuildContext context) {
  return const AmenitiesExpansionTileContent(digitalGuideData: _mockDigitalGuideData);
}
