...
import "package:topwr/features/parkings/parkings_view/widgets/parking_tile.dart";
...
@widgetbook.UseCase(name: "default", type: ParkingTile)
Widget useCaseParkingTile(BuildContext context) {
  return const ParkingTile(_productionParking, isActive: true);
}
