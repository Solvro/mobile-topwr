...
@widgetbook.UseCase(name: "default", type: FavouriteParkingWidget)
Widget useCaseFavouriteParkingWidget(BuildContext context) {
  return const FavouriteParkingWidget(_productionParking);
}
