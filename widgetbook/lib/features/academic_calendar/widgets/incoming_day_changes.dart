...
@widgetbook.UseCase(name: "default", type: IncomingDayChanges)
Widget useCaseIncomingDayChanges(BuildContext context) {
  return IncomingDayChanges(calendar: _productionAcademicCalendarWithSwaps);
}
