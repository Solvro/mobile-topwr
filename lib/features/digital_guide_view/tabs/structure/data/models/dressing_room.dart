...
class DressingRoom with _$DressingRoom {
  ...
  factory DressingRoom.fromJson(Map<String, dynamic> json) =>
      _$DressingRoomFromJson(json);
}
...
class DressingRoomTranslations with _$DressingRoomTranslations {
  ...
  factory DressingRoomTranslations.fromJson(Map<String, dynamic> json) =>
      _$DressingRoomTranslationsFromJson(json);
}
...
class DressingRoomTranslation with _$DressingRoomTranslation {
  ...
  factory DressingRoomTranslation.fromJson(Map<String, dynamic> json) =>
      _$DressingRoomTranslationFromJson(json);
}
