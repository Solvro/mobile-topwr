...
class DigitalGuideLift with _$DigitalGuideLift {
  const factory DigitalGuideLift({
    ...
    @JsonKey(name: "is_outside_arrival_notification_sound", fromJson: _stringToBool) required bool isOutsideArrivalNotificationSound,
    @JsonKey(name: "is_inside_arrival_notification_sound", fromJson: _stringToBool) required bool isInsideArrivalNotificationSound,
  ...
  IList<String> getBlindImpairmentValue(AppLocalizations l10n){
    ...
    return IList(
      [
        ...
        if(isInsideButtonBraille) l10n.with_inside_braile_comunicates else l10n.without_inside_braile_comunicates,
