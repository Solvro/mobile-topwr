...
extension SurroundingResponseOperationsX on BuildContext {
  ...
  IList<String> getSurroundingsCommentsListForBlind(
    SurroundingResponse surroundingResponse,
  ) {
    final comments = surroundingResponse.translations.plTranslation;
  ...
  IList<String> getSurroundingsCommentsListForLowVision(
    SurroundingResponse surroundingResponse,
  ) {
    final comments = surroundingResponse.translations.plTranslation;
  ...
  IList<String> getSurroundingsCommentsListForMotorDysfunction(
    SurroundingResponse surroundingResponse,
  ) {
    final comments = surroundingResponse.translations.plTranslation;
  ...
  IList<String> getSurroundingsCommentsListForCognitiveDifficulties(
    SurroundingResponse surroundingResponse,
  ) {
    final comments = surroundingResponse.translations.plTranslation;
  ...
  IList<String> getSurroundingsCommentsListForSensorySensitivity(
    SurroundingResponse surroundingResponse,
  ) {
    final comments = surroundingResponse.translations.plTranslation;
  ...
  IList<String> getSurroundingsCommentsListForHearingImpairment(
    SurroundingResponse surroundingResponse,
  ) {
    final comments = surroundingResponse.translations.plTranslation;
  ...
  AcessibilityCommentsTuple getSurroundingsCommentsTuple(
    SurroundingResponse surroundingResponse,
  ) {
    final AcessibilityCommentsTuple commentsTuple = (
      blind: getSurroundingsCommentsListForBlind(surroundingResponse),
      lowVision: getSurroundingsCommentsListForLowVision(surroundingResponse),
      cognitive: getSurroundingsCommentsListForCognitiveDifficulties(
          surroundingResponse,),
      motor:
          getSurroundingsCommentsListForMotorDysfunction(surroundingResponse),
      sensor:
          getSurroundingsCommentsListForSensorySensitivity(surroundingResponse),
      hearing:
          getSurroundingsCommentsListForHearingImpairment(surroundingResponse)
    );
