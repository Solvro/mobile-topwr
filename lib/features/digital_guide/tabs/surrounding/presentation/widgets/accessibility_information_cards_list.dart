...
class AccessibilityInformationCardsList extends StatelessWidget {
  const AccessibilityInformationCardsList({super.key, required this.accLevels, this.accComments});
    ...
    final widgets = [
      ...
      AccessibilityInformationCard(
        ...
        text:
            ...
            context.localize.accessibility_card_information(
              ...
              context.localize.accessibility_level_neuter(accLevels.accessibilityLevelForBlind.toString()),
      ...
      AccessibilityInformationCard(
        ...
        text:
            ...
            context.localize.accessibility_card_information(
              context.localize.surroundings,
              context.localize.accessibility_level_neuter(accLevels.accessibilityLevelForVisuallyImpaired.toString()),
      ...
      AccessibilityInformationCard(
        ...
        text:
            ...
            context.localize.accessibility_card_information(
              context.localize.surroundings,
              context.localize.accessibility_level_neuter(accLevels.accessibilityLevelForMotorDisability.toString()),
      ...
      AccessibilityInformationCard(
        ...
        text:
            ...
            context.localize.accessibility_card_information(
              context.localize.surroundings,
              context.localize.accessibility_level_neuter(accLevels.accessibilityLevelForHardOfHearing.toString()),
      ...
      AccessibilityInformationCard(
        ...
        text:
            ...
            context.localize.accessibility_card_information(
              context.localize.surroundings,
              context.localize.accessibility_level_neuter(
                accLevels.accessibilityLevelForHighSensorySensitivity.toString(),
              ),
