...
class RampsAccessibilityCommentsManager extends AccessibilityCommentsManager {
  RampsAccessibilityCommentsManager({
    required this.ramps,
    required this.l10n,
  });
  ...
  IList<String> getCommentsListForMotorImpairment() {
    ...
    return IList([
      ...
      if (pl.numberOfLandings.isNotEmpty)
        "${l10n.number_of_ramp_landings} ${pl.numberOfLandings}",
      if (pl.dimensionsOfTheLandings.isNotEmpty)
        "${l10n.dimensions_of_the_landings} ${pl.dimensionsOfTheLandings}",
    ]);
  }
