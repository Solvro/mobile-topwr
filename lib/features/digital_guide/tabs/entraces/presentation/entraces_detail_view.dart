...
class DigitalGuideEntranceDetailsView extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    final widgets = [
      Focus(
        autofocus: true,
        child: Text(entrance.translations.pl.name, style: context.textTheme.titleLarge?.copyWith(fontSize: 24)),
      ),
        ...
        itemBuilder: (context, index) {
          return DigitalGuideNavLink(
            onTap: () async {
              ...
              await ref.navigateDigitalGuideDoor(entrance.doorsIndices[index]);
            },
