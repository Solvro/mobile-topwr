...
import "package:topwr/features/digital_guide/tabs/transportation/presentation/transportation_expansion_tile_content.dart";
import "package:widgetbook/widgetbook.dart";

import "../../../../../widgetbook_mocks.dart";

part "transportation_expansion_tile_content.stories.g.dart";
...
final $default = TransportationExpansionTileContentStory(
  setup: (context, child, args) => ProviderScope(
    overrides: [
      transportationRepositoryProvider(args.digitalGuideData).overrideWith((ref) async => mockDigitalGuideTransportationC13),
    ],
    child: child,
  ),
  args: TransportationExpansionTileContentArgs(digitalGuideData: Arg.fixed(_mockDigitalGuideData)),
);
