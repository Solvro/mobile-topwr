...
part "entrances_expansion_tile_content.stories.g.dart";
...
const meta = Meta(EntrancesExpansionTileContent.new);
...
final $default = EntrancesExpansionTileContentStory(
  ...
  args: EntrancesExpansionTileContentArgs(digitalGuideData: Arg.fixed(_mockDigitalGuideData)),
);
